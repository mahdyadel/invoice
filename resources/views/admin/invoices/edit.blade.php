                                ...
                                <tr class="cloning_row" id="{{ $loop->index }}">
                                    ...
                                    <td>
                                        <select name="unit[{{ $loop->index }}]" id="unit" class="unit form-control">
                                            <option></option>
                                            <option value="pices" {{ $item->unit == 'pices' ? 'selected' : '' }}>{{ __('Frontend/frontend.pices') }}</option>
                                    ...
                                    <td>
                                        <div class="input-group mb-3">
                                            <select name="discount_type" id="discount_type" class="discount_type custom-select">
                                                <option value="fixed" {{ $invoice->discount_type == 'fixed' ? 'selected' : '' }}>{{ __('Frontend/frontend.eg') }}</option>
